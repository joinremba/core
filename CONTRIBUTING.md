# Contributing to @joinremba/core

Thank you for your interest in contributing to Core! We welcome contributions from everyone, whether it is a bug report, feature suggestion, documentation improvement, or code change.
...
- **Bun 1.3.1+** — Core uses Bun as its runtime and package manager. [Install Bun](https://bun.sh/docs/installation) if you have not already.
...
```sh
git remote add upstream https://github.com/joinremba/core.git
```
...
- **Zero dependencies** — Core must remain dependency-free. Do not add npm dependencies.
...
```
feat(core): add timeout option to createClient
fix(core): handle empty JOINREMBA_API_URL gracefully
docs(core): document webhook signing helpers
test(core): add tests for signPayload edge cases
```
...
If you need help or have questions, please open a [discussion](https://github.com/joinremba/core/discussions) or create an [issue](https://github.com/joinremba/core/issues).
